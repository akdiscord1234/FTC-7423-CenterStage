...
public class FieldCentric extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        lift = hardwareMap.dcMotor.get("lift"); //from old code

        //touch

        DigitalChannel touch = hardwareMap.get(DigitalChannel.class, "touch"); // old code
        ...
        lift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER); // from old code(and line below)
        ...
        while (opModeIsActive()){
            // lift controls and power
            //constant lift power
            //from old code
            lift.setPower(-0.15f); //old code
            if (gamepad2.b)
                lift.setPower(-0.5f); //old code
